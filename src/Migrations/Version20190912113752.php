 ...
 */
final class Version20190912113752 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, genre_id INT NOT NULL, author_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(1024) NOT NULL, publish INT NOT NULL, country VARCHAR(255) NOT NULL, availability TINYINT(1) NOT NULL, entry_date DATE NOT NULL, last_modyfication DATE NOT NULL, INDEX IDX_CBE5A3314296D31F (genre_id), INDEX IDX_CBE5A331F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
