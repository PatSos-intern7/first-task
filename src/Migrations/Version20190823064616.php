 ...
 */
final class Version20190823064616 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book ADD genre_id INT DEFAULT NULL, ADD entry_date DATE NOT NULL, ADD last_modyfication DATE NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book DROP genre_id, DROP entry_date, DROP last_modyfication');
    }
}
